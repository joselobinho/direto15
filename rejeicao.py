...
def sefaz_rejeicao(codigo):

	REJEICAO={
	"201":"O numero máximo de numeração de NF-e a inutilizar ultrapassou o limite                                                         ",
	...
	"218":"NF-e já esta cancelada na base de dados da SEFAZ                                                                               ",
	"219":"Circulação da NF-e verificada                                                                                                  ",
	"220":"NF-e autorizada há mais de 7 dias (168 horas)                                                                                  ",
	...
	"503":"Série utilizada fora da faixa permitida no SCAN insert into RejeicaoPortal values(900-999)                                     ",
	...
	"508":"O CNPJ com conteúdo nulo só é válido em operação com exterior                                                                  ",
	"509":"Informado código de município diferente de “9999999” para operação com o exterior                                              ",
	"510":"Operação com Exterior e Código País destinatário é 1058 insert into RejeicaoPortal values(Brasil) ou não informado             ",
	"511":"Não é de Operação com Exterior e Código País destinatário difere de 1058 insert into RejeicaoPortal values(Brasil)             ",
	...
	"521":"CFOP não é de Operação com Exterior e UF destinatário é EX                                                                     ",
	"522":"CFOP de Operação Estadual e UF emitente difere UF destinatário.                                                                ",
	...
	"526":"CFOP de Exportação e não informado Local de Embarque                                                                           ",
	...
	"539":"Duplicidade de NF-e, com diferença na Chave de Acesso [99999999999999999999999999999999999999999]                              ",
	...
	"558":"Data de entrada em contingência posterior a data de emissão.                                                                   ",
	"559":"UF do Transportador não informada                                                                                              ",
	"560":"CNPJ base do emitente difere do CNPJ base da primeira NF-e do lote recebido                                                    ",
	"561":"Mês de Emissão informado na Chave de Acesso difere do Mês de Emissão da NFe                                                    ",
	"562":"Código Numérico informado na Chave de Acesso difere do Código Numérico da NF-e                                                 ",
	...
	if codigo in REJEICAO:	return REJEICAO[codigo].strip()
	else:	return ''
