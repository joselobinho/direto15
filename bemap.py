...
###a+= chr(27) + chr(116) + chr(1) + "CNPJ: 12.112.856/0001-38 Ins.Estadual: 79101974\nAV.Automvel Clube, 1747 Vilar dos Teles\nSao Joao do Meriti RJ\n"+("."*48)
...
###a+="\n"+("."*48)
###
###a+= chr(27) + chr(97) + chr(1)+ chr(27) + chr(87) + chr(1)+"CONSUMIDOR"+ chr(27) + chr(87) + chr(0) + chr(27) + chr(97) + chr(0)
...
a =chr(27) + chr(97)  + chr(1)
a+=chr(29) + chr(107) + chr(81)
a+=chr(2)  + chr(6)   + chr(2) + chr(1)
a+=chr(x1) + chr(x2)
a+=chr(1) #-: Talve o bit de partida seja o x1
print x1,x2

for i in ll:
  # print i,ord(i)
   if i.strip() !="":	a+= chr( ord(i) )

#a+=chr(119) + chr(119) + chr(119) + chr(46) + chr(98) + chr(101) + chr(109) + chr(97) + chr(116) + chr(101) + chr(99) + chr(104) + chr(46) + chr(99) + chr(111) + chr(109) + chr(46) + chr(98) + chr(114) #;         // aqui começa o texto
