...
gerencianet: assinatura eletronica:  TEDAE

pip2.7 install python-escpos==3.0a4
senha do aws: 151407J@l
usuario: joselobinho@gmail.com
nome da contao: direto
...
38-Parametros do ACBr      ep_acbr text,                                #03-09-2019 para o CPF/CNPJ do contador para autorizar o download do NFe
...
42-Banckp-cloud online     ep_bkcl MEDIUMBLOB,                  #26/11/2018
43-Sequencia da MDFe       ep_mdfe int(10) default 0,
44-Serie MDFe              ep_smdf varchar(3) default '');
...
19-NFCe CheckOut           us_nnfc int(9),
20-NFCe Serie              us_nfcs varchar(3),
21-TF Prducao/Homologacao  us_proh varchar(1),
22-Numero do DAV           us_ndav int(7));
...
11- endereco               pd_ende varchar(30) default '',
...
50- hash3                  pd_has3 varchar(256)  default '',                                                                           #Usando para colocar o preco do busca preco                                                                        
...
92-Precos p/Filial         pd_endd varchar(30) default '',
93-Controle de nSerioe     pd_nser varchar(1) default '',
94-Codigo-Corte-cloud      pd_clou varchar(30) default '',
95-Loja virtual            pd_lvir varchar(30) default '',
96-AlertaFiscalDataAtualza pd_afat varchar(30) default '',
INDEX(pd_nome),
INDEX(pd_codi));
...
10- endereco       it_ende varchar(30) default '',  
...
23- vlr unit peca  it_unpc decimal(15,4) default 0,                                                #-:alterado em 23-11-2018 sergil
...
102 Dados DOF      it_idof MEDIUMBLOB,
103 Dsoneracao '|' it_deso MEDIUMBLOB,
104 QTExpedicaoLog it_logi decimal(15,4) default 0,                                            # QT Entregue na expedicao logistica
INDEX (it_ndav),
INDEX (it_lanc),
INDEX (it_dcan),
...
73-Chave NFE        cr_chnf varchar(44)   default '',
...
96-Sequencial ECF   cr_ecfs varchar(3)  default '',                                                          #usado para marcar com emissao consolidada de NF
...
117-TitalizaTabelas cr_tabe MEDIUMBLOB,
118-ChComplementar  cr_chcp varchar(44),                                                                                           #Chave ferenciada para Nota fiscal complementar
119-Observacao      cr_vobs MEDIUMBLOB,
120-Desoneracao '|' cr_deso MEDIUMBLOB,
121-Tipovenda       cr_twtp varchar(1) default '',                                                                       #{Tipo de venda} 1-web, 2-Telefone 3-Presencial
122-Numero PED WEB  cr_pdwb varchar(30) default '',                                                                      #Numero do Pedido e-commerce
123-OrigemPedidoWeb cr_pdor varchar(3) default '',                                                                       #ORIGEM [WOO]-woocommerce [CCL]-CorteCloud
INDEX(cr_edav),
INDEX(cr_ndav)
...
01- nome             cl_nomecl varchar(100) default '',
...
55-T-ClienteAgregado cl_agrega varchar(1)   default '',
56-VenciValores      cl_ldados MEDIUMBLOB,                                          # dados Lykos ERP=Valor,vencimento, Manutencao=Valor,Vencimento, Servico cloud=Valor,Vencimento, Outros Servicos=valor,vencimento
57-Codigo-BancoBolto cl_cdbanc varchar(8)   default '',
58-CodigoCorte-cloud cl_ccloud varchar(30) default '',
59-Bloqueio remoto   cl_bloque varchar(1) default '',
60-Url server client cl_urclie varchar(300) default '',
61-Quem cadastrou    cl_uscada varchar(50) default '',
62-LojaVirtualOrigem cl_lvorig varchar(3) default '');
...
28-Ch Documento      rc_chdocu varchar(20)  default '',
...
37-1-ARe 2-CX        rc_recebi varchar(1)   default '',
...
88-LancamentoCLIENTE rc_littus varchar(1)   default '',
INDEX receber(rc_dtlanc),
INDEX receber(rc_dtbaix),
INDEX receber(rc_vencim),
INDEX receber(rc_status)
INDEX receber(rc_cpfcnp));
...
18-vlr unit peca     tm_unpc decimal(15,4) default 0,                                      #alterado em 23-11-2018 SERGIL vendas de piso
...
24-endereco          tm_ende varchar(30)   default '',  
...
98-Estoque local     ic_locale varchar(1)    default "",
INDEX (ic_lancam),
INDEX (ic_dtcanc)
INDEX (ic_lancam,ic_cdprod));
#informacoes temporario para emissao da nfe de rma
...
54-DT competencia    ap_dtcomp date default '00-00-0000',
...
32-dado XML Original nf_urlqrc MEDIUMBLOB,
...
""" nf_tipnfe 1-Venda,2-Devolucao de Vendas,3-Comras{Entrada de Mercadorias},4-Devolucao Compras-RMA,5-Transferencia,6-Simples Faturamento
	...
	nf_oridav 1-Venda   2-Compras    3-Check-out
...
05-DescricaoSubConta 5  pl_dcont5 varchar(60) default '');
...
12-endereco             tc_ende varchar(30) default '',  
...
08-Endereco no estoque  ef_endere varchar(30)  default '',                                                       #15-05-2018
INDEX (ef_codigo),
...
00-ID Lancamento     create table nc_notdat (nc_regist int(10) not null auto_increment primary key,
...
00 create table bancoconta (bc_regist int(14) not null auto_increment primary key,
01 bc_docume varchar(50)  default '',
02 bc_dlanca date         default '00-00-0000',
03 bc_hlanca time         default '00:00:00',
04 bc_idcada varchar(8)  default '',
05 bc_planoc varchar(20)  default '',
06 bc_valora decimal(15,2) default 0,
07 bc_valorc decimal(15,2) default 0,
08 bc_valord decimal(15,2) default 0,
09 bc_valors decimal(15,2) default 0,
10 bc_histor MEDIUMBLOB,
11 bc_hiscur varchar(200)  default '',
12 bc_filial varchar(5)  default '',
13 bc_usuari varchar(20)  default '',
14 bc_origem varchar(100)  default '',
15 bc_tipola varchar(2)  default '',
16 bc_bcorig varchar(200)  default '',
17 bc_doccom varchar(20)  default '',
18 bc_dtrefe date         default '00-00-0000',
19 bc_docapa varchar(20)  default '',
INDEX (bc_dlanca),
INDEX (bc_idcada),
INDEX (bc_planoc),
INDEX (bc_dtrefe));

#// Controle de NFes emitida contra o cnpj da filial
00 - _id do Grupo             create table nfecompras (nc_regi int(10) not null auto_increment primary key,
01 - Identificacao do Grupo   nc_filial varchar(5)   default '',
02 - Data-Lancamento           nc_dlanca date         default '00-00-0000',
03 - Hora-Lancamento           nc_hlanca time         default '00:00:00',
04 - Usuario                   nc_usuari varchar(12)  default '',
05 - Emissao da nota           nc_emissn varchar(50)  default '',
06 - Numero da chave           nc_nchave varchar(44)  default '',
07 - Protocolo                 nc_protoc varchar(30)  default '',
08 - valor da nota             nc_nvalor decimal(15,2) default 0,
09 - XML da nf-1sim 2-nao      nc_xmldis varchar(1)   default '',
10 - CNPJ-Emitente             nc_emcnpj varchar(14)  default '',
11 - Nome-Emitente             nc_emnome varchar(120) default '',
12 - Numero NSU				   nc_numnsu int(15) default 0,
13 - Data-Emissao              nc_demiss date default '00-00-0000',
14 - Nota manifestada {1}      nc_manife varchar(1)   default '',
15 - 1-Emitente 2-Destinatario nc_cancel varchar(100) default '',
16 - XML da NFe                nc_arqxml MEDIUMBLOB,
INDEX (nc_filial),
INDEX (nc_dlanca),
INDEX (nc_nchave),
INDEX (nc_emcnpj),
...
00 - id lcancamento  create table nfeoriginal (no_regis int(10) not null auto_increment primary key,
01 - Numero da chave no_chave varchar(44)  default '',
12 - XML da NFe      no_arxml MEDIUMBLOB,
03 - XML assinado    no_asxml MEDIUMBLOB,
INDEX (no_chave));

00 - id lcancamento  create table mdfecadastro (md_regis int(10) not null auto_increment primary key,
01 - codigo     md_codig varchar(2)  default '', #--// 01-cadasro do veiculo, 02-cadastro do condutor
02 - informacao md_cadas MEDIUMBLOB)); #// Cadastro do Veiculo, cadastro de condutor

00 - ID              create table mdfecontrole (md_regis int(10) not null auto_increment primary key,
01 - Filail          md_filial varchar(5) default '',
02 - Numero MDFE     md_numdfe varchar(9) default '',
03 - Ambiente        md_ambien varchar(1) default '',
04 - Serie           md_nserie varchar(3) default '',
05 - cStat           md_cstatu varchar(3) default '',
06 - MDFeDataEmissao md_emissa date default '00-00-0000',
07 - MDFeHoraEmissao md_horaem time default '00:00:00',
08 - MDFeUusario     md_usuari varchar(12) default '',
09 - UF-Inicial      md_ufinic varchar(2) default '',
10 - UF-Final        md_uffina varchar(2) default '',
11 - Numero da chave md_nchave varchar(44) default '',
12 - Protocolo       md_protoc varchar(30) default '',
13 - Recibo          md_recibo varchar(30) default '',
14 - X M L           md_xmlmdf MEDIUMBLOB,
15 - Encerramento    md_xmlenc MEDIUMBLOB,
16 - Cancelamento    md_xmlcan MEDIUMBLOB,
17 - Rejeicao        md_xmlrej MEDIUMBLOB,
18 - status          md_status varchar(1) default '',
19 - US Emissao      md_usemis date default '00-00-0000',
20 - US Hora         md_ushora time default '00:00:00',
21 - UusarioEmissao  md_ususua varchar(12) default '',
22 - usDThr          md_dadosu MEDIUMBLOB,                                                                         #usuario encerramento,usuario inutilizacao, usuario cancelamento
23 - Relacao NFe     md_relnfe MEDIUMBLOB,                                                                         #usuario encerramento,usuario inutilizacao, usuario cancelamento
...
""" md_status vazio(inutilizacao) 1-emitido,2-Emitido e encerrado,3-canceldo """

00 - ID               create table individualcheque (ac_regis int(10) not null auto_increment primary key,
01 - Filail           ac_filial varchar(5) default '',
02 - favorecido       ac_favore varchar(120) default '',
03 - DataEmissao      ac_emissa date default '00-00-0000',
04 - HoraEmissao      ac_horaem time default '00:00:00',
05 - Usuario          ac_usuari varchar(12) default '',
06 - valor            ac_valord decimal(15,2) default 0,
07 - NumeroCheque     ac_numero varchar(20) default '',
08 - 5-ChFilia6-ChTer ac_tipola varchar(1) default '',
09 - 1-liquidad 2-can ac_liquid varchar(1) default '',
10 - RelacaoVinculado ac_xmlmdf MEDIUMBLOB,
11 - dados chequeBanc ac_xmlenc MEDIUMBLOB,
12 - ListaFavorecido  ac_lifavo MEDIUMBLOB,
13 - DataVencimento   ac_vencim date default '00-00-0000',
14 - InfLiq.Cancel    ac_informd MEDIUMBLOB,
INDEX (ac_filial),
INDEX (ac_favore),
INDEX (ac_emissa),
INDEX (ac_numero),
...
davs.py na linha 9638 { o campo pedi 4 casas decimais e eu trunquei para as 4 casas decimais e funcionou 1.0000 tava indo 1.0000000 acho q era isso }
...
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
EXPORTANDO PARA ARQUIVO CSV { Utilizando o comando de linha mysql }
mysql -hmonfardiniwood.is-by.us -uroot -p151407jml -e "SELECT pd_codi,pd_barr,pd_nome,pd_tpr1 from produtos" monfa | sed 's/\t/","/g;s/^/"/;s/$/"/' > /mnt/lykos/eliardo.csv
$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
...
https://www.vivaolinux.com.br/topico/Impressoras/Bematech-MP-4200-TH-Cupom-nao-fiscal

duplicidade de registros
SELECT DISTINCT pd_regi,pd_codi FROM produtos GROUP BY pd_codi HAVING count(pd_codi) > 1
