...
from produtod  import RelacionarProdutosPrecompra
from nfe2      import editadanfe
from planilhas import LerGrade
from nfe310    import nfe31c
...
class compras(wx.Frame):
	...
	def __init__( self, parent, id, prd ):
		...
		self.p.Disable()
		wx.Frame.__init__(self, parent, id, '{ Produtos } '+ self.idf +' '+ self.nmf +' Controle de compras', size=(965,502), style=wx.CAPTION|wx.FRAME_FLOAT_ON_PARENT|wx.CLOSE_BOX)
	...
	def relato(self,event):
		...
		self.c.compras( self, pedido, TipoPd, Filiais = self.idf, email = acs.acsm("212",True), mostrar = True )
...
class listaCompra(wx.Frame):
	...
	def __init__(self,parent,id):
		...
		#--------------------------:[ Cobranca ]
		self.ListaCob = wx.ListCtrl(self.painel, 310,pos=(52,324), size=(406, 115),
						 			style=wx.LC_REPORT
									|wx.BORDER_SUNKEN
									|wx.LC_HRULES
									|wx.LC_VRULES
		...
		wx.StaticText(self.painel,-1,u"Base Calculo ICMS",  pos=(622,387)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		wx.StaticText(self.painel,-1,u"Valor ICMS",         pos=(742,387)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		wx.StaticText(self.painel,-1,u"Base Calculo ST",    pos=(862,387)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		...
		wx.StaticText(self.painel,-1,u"Valor Seguro",       pos=(742,420)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		wx.StaticText(self.painel,-1,u"Valor Desconto",     pos=(862,420)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		...
		wx.StaticText(self.painel,-1,u"Valor PIS",          pos=(742,452)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		wx.StaticText(self.painel,-1,u"Valor COFINS",       pos=(862,452)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))

		wx.StaticText(self.painel,-1,u"Outras Despesas",    pos=(742,485)).SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		Tn = wx.StaticText(self.painel,-1,u"Total Nota {xml}",  pos=(858,485))
		...
		wx.StaticText(self.painel,-1,u"NFe: Nº Chave p/Consulta, Manifesto e Download", pos=(423,670)).SetFont(wx.Font(7, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
		...
		#mane = wx.StaticText(self.painel,-1,u"Manejo extração $:", pos=(762,652))
		...
		self.ap = wx.StaticText(self.painel,-1,u"", pos=(250,445))
		...
		self.adicionado = wx.StaticText(self.painel,-1,"",  pos=(800,565))
		self.adicionado.SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		...
		self.QTATual.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
...
#---------------------: Totalizacao do XML
		...
		self.TBaseic = wx.TextCtrl(self.painel,-1,'', pos=(618,399), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.TBaseic.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.TBaseic.SetBackgroundColour('#E5E5E5')

		self.Tvlricm = wx.TextCtrl(self.painel,-1,'', pos=(738,399), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.Tvlricm.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.Tvlricm.SetBackgroundColour('#E5E5E5')
		
		self.TBaseST = wx.TextCtrl(self.painel,-1,'', pos=(858,399), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		...
		self.Tvfrete = wx.TextCtrl(self.painel,555,'', pos=(618,431), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.Tvfrete.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.Tvfrete.SetBackgroundColour('#E5E5E5')

		self.Tvsegur = wx.TextCtrl(self.painel,-1,'', pos=(738,431), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.Tvsegur.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.Tvsegur.SetBackgroundColour('#E5E5E5')

		self.Tvdesco = wx.TextCtrl(self.painel,-1,'', pos=(858,431), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		...
		self.Tvlripi = wx.TextCtrl(self.painel,-1,'', pos=(618,463), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.Tvlripi.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.Tvlripi.SetBackgroundColour('#E5E5E5')

		self.Tvlrpis = wx.TextCtrl(self.painel,-1,'', pos=(738,463), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.Tvlrpis.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.Tvlrpis.SetBackgroundColour('#E5E5E5')

		self.Tvcofin = wx.TextCtrl(self.painel,-1,'', pos=(858,463), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		...
		self.Tvlrout = wx.TextCtrl(self.painel,-1,'', pos=(738,498), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
		self.Tvlrout.SetFont(wx.Font(9, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.Tvlrout.SetBackgroundColour('#E5E5E5')

		self.Tvnotaf = wx.TextCtrl(self.painel,-1,'', pos=(858,498), size=(105,20),style = wx.ALIGN_RIGHT|wx.TE_READONLY)
...
#-----: Por fora e antecipado Valor unitario, Quantidade Unidade,Frete,Desconto
		self.vlrunit = mkn(self.painel, 304, value = "0.0000", pos=(17, 560), style = wx.ALIGN_RIGHT|wx.TE_READONLY, integerWidth = 5, fractionWidth = 4, groupChar = ',', decimalChar = '.', foregroundColour = "#FFFFFF", signedForegroundColour = "Red", emptyBackgroundColour = '#7F7F7F', validBackgroundColour = '#7F7F7F', invalidBackgroundColour = "Yellow",allowNegative = False,selectOnEntry=True)
		self.QTUnida = mkn(self.painel, 260, value = "0.0000", pos=(120,560), style = wx.ALIGN_RIGHT|wx.TE_READONLY, integerWidth = 6, fractionWidth = 4, groupChar = ',', decimalChar = '.', foregroundColour = "#FFFFFF", signedForegroundColour = "Red", emptyBackgroundColour = '#7F7F7F', validBackgroundColour = '#7F7F7F', invalidBackgroundColour = "Yellow",allowNegative = False,selectOnEntry=True)
		...
		"""   Numero da Chave de NFe, manifesto, download   """
		self.NumChave = wx.TextCtrl(self.painel,771,'', pos=(420,679), size=(332,22))
		self.NumChave.SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.BOLD,False,"Arial"))
		self.NumChave.SetBackgroundColour('#7F7F7F')
		self.NumChave.SetForegroundColour('#FFFFFF')
		self.NumChave.SetMaxLength(44)

		""" Selecionar Filial p/Transferencia do Estoque """
		if nF.fu( self.fid ) == "T":	rlFiliais = login.ciaRemot
		...
		self.vlrunit.SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL,False,"Arial"))
...
#----------: Radio-Check Pedido,Devolucao,Transverencia
		...
		self.elocal = wx.RadioButton(self.painel,-1, u"Estoque local   ", pos=(130,439))

		#self.elocal.Enable( False )
		...
		#self.embala = wx.CheckBox(self.painel, 213,  u"QT p/embalagens",    pos=(130,479))
...
#----------: Icones 
		...
		nfeMani = wx.BitmapButton(self.painel, 324, wx.Bitmap("imagens/ok16.png",      wx.BITMAP_TYPE_ANY), pos=(459,361), size=(36,38))
		...
		salvar = wx.BitmapButton(self.painel, 204, wx.Bitmap("imagens/savep.png",  wx.BITMAP_TYPE_ANY), pos=(457,500), size=(38,35))				
		...
		nfeMani.Bind(wx.EVT_ENTER_WINDOW, self.OnEnterWindow)
		...
		nfeMani.Bind(wx.EVT_LEAVE_WINDOW, self.OnLeaveWindow)
		nfeDown.Bind(wx.EVT_LEAVE_WINDOW, self.OnLeaveWindow)

		voltar.Bind(wx.EVT_BUTTON, self.sair)
		salvar.Bind(wx.EVT_BUTTON, self.gravarDanfe)
		
		nfeCons.Bind(wx.EVT_BUTTON, self.consultarNFe)
		nfeMani.Bind(wx.EVT_BUTTON, self.consultarNFe)
		nfeDown.Bind(wx.EVT_BUTTON, self.consultarNFe)
	...
	def consultarNFe(self,event):
		...
		"""  Utilizando o firefox e/ou google-chrome-stable  """
		if event.GetId() == 322 and len( login.filialLT[ self.fid ][35].split(";") ) >= 92 and len( login.filialLT[ self.fid ][35].split(";")[91].split("|") ) >= 2 and login.filialLT[ self.fid ][35].split(";")[91].split("|")[1]:
					
			site, tipo_navegador = login.filialLT[ self.fid ][35].split(";")[91].split("|")

			if str( tipo_navegador ) in ["1","2"]:

				if str( tipo_navegador ) == "1":	abrir = subprocess.Popen("firefox "+site, shell=True,stdout=subprocess.PIPE)
				if str( tipo_navegador ) == "2":	abrir = subprocess.Popen("google-chrome-stable "+site, shell=True,stdout=subprocess.PIPE)

			else:	alertas.dia(self, "{ Tipo de navegador incorreto [ configurar em parametros do sistema ] }\n\nUse ao final do endereço [  |1  ou  |2  ]\n"+(" "*160),"Download da NFs")

		else:
			
			NunChave = self.NumChave.GetValue().strip()
			if NunChave !="" and len( NunChave ) == 44 and NunChave.isdigit():
				
				login.downXML = ""

				if event.GetId() == 321:	NFE31Man.manutencao( self, 6, NunChave, Filial = self.fid )
				if event.GetId() == 324:	NFE31Man.manutencao( self, 8, NunChave, Filial = self.fid )
				if event.GetId() == 322:	NFE31Man.manutencao( self, 7, NunChave, Filial = self.fid )
				...
				if login.downXML !="":
					...
					self.a = login.downXML
					self.abrirDanfe(wx.EVT_CHECKBOX)

			else:	alertas.dia(self,"Chave de Acesso: "+str( self.acerToMoti.GetValue() )+u", Nº Caracters: "+str( len( self.acerToMoti.GetValue().strip() ) )+u"\n\na - Numero de digitos inferior 44 digitos\nb - Numero de chave vazia\nc - Numero de chave for composta com letras e numeros\n"+(" "*160),"NFe: Consulta,Manifesto e Download")
	...
	def recalculaST(self):
		...
		if nReg !=0 and self.TTprodu.GetValue() !='' and self.acerto.GetValue() !=True:
			...
			mediaST = mediaFr = mediaDs = TFora = mediaDa = mediaSe	= mediaFi = Decimal('0.00')
			...
			for i in range(nReg):
				...
				if prcun != 0:
					...
					vc = self.T.trunca(1, ( ( prcun + vST + vFr + FX + vDa + vSe + vFi + TTIUN ) - vDs ) ) #--: Valor do custo
	...
	def Tvalores(self,valor,idfy):
		...
		else:	valor = str( self.T.trunca(1, Decimal( valor ) ))

		if idfy == 260 or idfy == 209:
			
			self.QTUnida.SetValue(valor)
			self.QTATual.SetLabel("QT:{"+str(valor)+"}")
			self.QTUnida.SetBackgroundColour('#7F7F7F')
	...
	def lprodutos(self,event):
		...
		"""   Bloqueios   """
		bloqueios = True
		if self.pedido.GetValue() == True:	bloqueios = acs.acsm("214", True)
		if self.devolu.GetValue() == True:	bloqueios = acs.acsm("215", True)
		if self.transf.GetValue() == True:	bloqueios = acs.acsm("216", True)
		if self.orcame.GetValue() == True:	bloqueios = acs.acsm("217", True)
		if self.acerto.GetValue() == True:	bloqueios = acs.acsm("218", True)
	...
	def OnEnterWindow(self, event):
		...
		elif event.GetId() == 324:	sb.mstatus("  Manifesto da NFe",0)
	...
	def passagem(self,event):
		...
		if self.ListaCMP.GetItemCount():
			...
			if nQuanT !='' and Decimal(nQuanT) !=0:	self.QTATual.SetLabel("QT:{"+str(nQuanT)+"}")
...
#---------:[ Leitura do XML do DANFE ]
	...
	def abrirDanfe(self,event):
		...
		if sql[0] == True:
			...
			try:
				...
				if ccd == []:	alertas.dia(self.painel,"Sem dados do danfe para importar !!","Produtos: { Importação do DANFE }")
					...
					for i in ccd:
						...
						custo = self.T.trunca(1, ( cvun + vcipi+ vcstb + vfrete ) - vdesco )
			...
			if final == False:	alertas.dia(self.painel,u"[Erro] Importação do XMLF!!\n\nRetorno:\n"+str(_reTornos)+"\n"+(" "*80),"Compras: Importação do XML")
			else:	self.recalculaST()
			...
			if _gravar.ShowModal() ==  wx.ID_YES:
				...
				if NumeroCTR !=0:
					...
					if sql[0]:
						...
						acerToEs = str( self.acerToMoti.GetValue().strip() )
						...
						try:
							...
							for i in range(nRg):
								...
								scs = str(self.ListaCMP.GetItem(ind, 34).GetText()) #--: 29 COFINS-CST
								sbc = str(self.ListaCMP.GetItem(ind, 35).GetText()) #--: 30 COFINS-Valor-BaseC
								spe = str(self.ListaCMP.GetItem(ind, 36).GetText()) #--: 31 COFINS-Percentual
								svl = str(self.ListaCMP.GetItem(ind, 37).GetText()) #--: 32 COFINS-Valor

								fcs = str(self.ListaCMP.GetItem(ind, 34).GetText()) #--: 33 COFINS-CST
								fbc = str(self.ListaCMP.GetItem(ind, 35).GetText()) #--: 34 COFINS-Valor-BaseC
								fpe = str(self.ListaCMP.GetItem(ind, 36).GetText()) #--: 35 COFINS-Percentual
								fvl = str(self.ListaCMP.GetItem(ind, 37).GetText()) #--: 36 COFINS-Valor

								npd = str(self.ListaCMP.GetItem(ind, 38).GetText()) #--: 37 Nº Pedido
								...
								qTFch = qco #-: Selecionar a Quantidade p/Unidade se for maior q zero se nao quantidade norma { Implementar Ficha de Estoque }
								...
								if pedido != "5": #-: 5-Orçamento
									...
									anTerior = "SELECT pd_estf,pd_marg,pd_mrse,pd_mfin,pd_pcom,pd_pcus,pd_cusm,pd_coms,pd_tpr1,pd_tpr2,pd_tpr3,pd_tpr4,pd_tpr5,pd_tpr6,pd_vdp1,pd_vdp2,pd_vdp3,pd_vdp4,pd_vdp5,pd_vdp6, pd_pcfl from produtos WHERE pd_codi='"+str( _pdp )+"'"
								...
								ic_unmaid,ic_unnome,ic_unfant,ic_undocu,ic_idforn)\
								VALUES(%s,%s,%s,%s,%s,\
								%s,%s,%s,%s,%s,\
								%s,%s,%s,%s,%s,\
								%s,%s,%s,%s,%s,\
								...
								sql[2].execute(items,
								(nCtrl,self._docume,self._nomefo,cbr,bar,\
								dsc,ncm,cfo,uco,qco,\
								vuc,vTp,uTb,qTv,vuT,\
								npd,cfi,cso,cst,csn,\
								imb,ims,pce,ivb,ipe,\
								...
								self.unmcodi,self.unmnome,self.unmfant,self.unmdocu,self.id_forn ) )  
								...
								if Fisico == True:                                                                                                                       
									...
									if self.pedido.GetValue() == True:	lsVenda = self.m.cva(sql[2],'CM',_pdp,self._numenf,self._nomefo,qco,vuc,vTp,custo,_ipi,_stb,_pis,_cof,_nQT,nCtrl,FisicoAn,'',AlTMarge,self.fid,self._repres)
									if self.acerto.GetValue() == True:	lsVenda = self.m.cva(sql[2],'AC',_pdp,self._numenf,self._nomefo,qco,vuc,vTp,custo,_ipi,_stb,_pis,_cof,_nQT,nCtrl,FisicoAn,_ens,'',self.fid,'')
									if self.transf.GetValue() == True:	lsVenda = self.m.cva(sql[2],'TR',_pdp,self._numenf,self._nomefo,qco,vuc,vTp,custo,_ipi,_stb,_pis,_cof,_nQT,nCtrl,FisicoAn,_ens,'',self.fid,'')
									if self.devolu.GetValue() == True:	lsVenda = self.m.cva(sql[2],'DV',_pdp,self._numenf,self._nomefo,qco,vuc,vTp,custo,_ipi,_stb,_pis,_cof,_nQT,nCtrl,FisicoAn,_ens,'',self.fid,'')
									...
									if self.pedido.GetValue() == True and lsVenda[0] == True:	compras = lsVenda[1]
									if self.pedido.GetValue() == True and lsVenda[0] == True:	margens = lsVenda[3]
									if self.acerto.GetValue() == True and lsVenda[0] == True:	acertos = lsVenda[1]
									if self.transf.GetValue() == True and lsVenda[0] == True:	transfe = lsVenda[1]
									if self.devolu.GetValue() == True and lsVenda[0] == True:	devoluc = lsVenda[1]
									...
									if sql[2].execute( consulTa ):
										...
										if self.elocal.GetValue() and _ens == "S":	saldo_local -= qco
										if self.elocal.GetValue() and _ens != "S":	saldo_local += qco
										...
										if self.acerto.GetValue() == True or self.devolu.GetValue() == True:
											...
											if self.devolu.GetValue() == True:	sql[2].execute( estoque, ( devoluc, _pdp ) )
											else:	sql[2].execute( estoque, ( acertos, _pdp ) )
											
										elif self.transf.GetValue() == True:
											...
											if nF.fu( self.fid ) == "T":	eFisico = "UPDATE estoque SET ef_esloja=( %s ) WHERE ef_codigo=%s"
											else:	eFisico = "UPDATE estoque SET ef_esloja=( %s ) WHERE ef_idfili=%s and ef_codigo=%s"

											if nF.fu( self.fid ) == "T":	sql[2].execute( saldo_local,( saldo_local, _pdp ) )
											else:	sql[2].execute( eFisico,(saldo_local, self.fid, _pdp ) )
											...
											pd_tpr5=%s,pd_tpr6=%s,pd_vdp1=%s,pd_docf=%s,pd_fbar=%s,pd_marp=%s,pd_pcfl=%s, pd_altp=%s WHERE pd_codi=%s"

											if nF.fu( self.fid ) == "T":	sql[2].execute(eFisico,( e_saldo, _pdp ) )
											else:	sql[2].execute(eFisico,( e_saldo, self.fid, _pdp ) )
											
											sql[2].execute(estoque, ( compras, vuc, custo, _marge1, cusm, _venda1, _dc2, _dc3, _dc4, _dc5, _dc6, real, docForncedor, cbr,margens, _psf, ajP, _pdp ) )
							...
							if self.apagar.GetValue() and self.ListaCob.GetItemCount():
								...
								for i in range( apRg ):
									...
									_apagar = "INSERT INTO apagar (ap_docume,ap_nomefo,ap_fantas,ap_ctrlcm,\
												...
												ap_dtvenc,ap_duplic,ap_parcel,ap_valord,ap_filial,ap_pagame,ap_confer,ap_hiscon,ap_lanxml,ap_rgforn,ap_contas,ap_vlorig,ap_uniman)\
												VALUES(%s,%s,%s,%s,\
												%s,%s,%s,%s,\
									...
									sql[2].execute(_apagar,
												(Docu,Desc,Fant,nCtrl,\
												self._numenf,self._dtlanc,self._hrlanc,self._uslanc,\
												aven, adup, parc, avlp, self._filial, boleTo, conf, hist, Tlan, idfr, plcn, avlp, manejo ) )
...
#---: Calculo e recalculo do pedido
	def calculoTotais(self):
		...
		for i in range(nregis):
			...
			vTs += Decimal(self.ListaCMP.GetItem(indice,33).GetText()) #-:[ Valor do PIS ]
			vTc += Decimal(self.ListaCMP.GetItem(indice,37).GetText()) #-:[ Valor do COFINS ]
...
class InfoCompra(wx.Frame):
	...
	def __init__(self,parent,id):
		...
		if self.p.rs[0][27] == '2':	TipoLancam = "2-Pedido de acerto"
		if self.p.rs[0][27] == '3':	TipoLancam = "3-Pedido de devolução de RMA"
		if self.p.rs[0][27] == '4':	TipoLancam = "4-Pedido de transferência"
...
class duplicatas(wx.Frame):
	...
	def __init__(self,parent,id):
		...
		wx.Frame.__init__(self, parent, id, 'Compras: { Alteração-Inclusão de Títulos }', size=(405,285), style = wx.CAPTION|wx.FRAME_FLOAT_ON_PARENT|wx.CLOSE_BOX)
		self.painel = wx.Panel(self)
		self.painel.Bind(wx.EVT_PAINT,self.desenho)
		self.Bind(wx.EVT_KEY_UP,self.Teclas)
		self.Bind(wx.EVT_CLOSE, self.sair)
		...
		self.mensa = wx.StaticText(self.painel,-1,"{ Mensagem }", pos=(270,100))
		...
		self.TpLancamen = wx.ComboBox(self.painel, -1, login.TpDocume[1], pos=(13,113), size=(245,26), choices = login.TpDocume, style=wx.CB_READONLY)
		...
		if self._id == 222 or self._id == 310:
			...
			Lancam = ( int( self.p.ListaCob.GetItem(indice,5).GetText() ) )
		...
		if self.saldo <= 0:
			...
			self.mensa.SetLabel('Sem saldo para\nParcelamento')
...
#						self.p.ListaCob.SetStringItem(reG,1,  str(vn))
...
#						vn = ( nv + datetime.timedelta(days=it) ).strftime("%d/%m/%Y")
						ordems +=1
						reG    +=1
#						it     +=it
						ndias  += _ndia
...
#--------------:[ Inclusao ]			
		...
		#if self.p.devolu.GetValue() == True and self.p.selXmlRma !=[]:	Tamanho = 650
		#else:	Tamanho = 602
		Tamanho = 650
...
#-----: Estoque fisico das filiais
		...
		self.estoque_filial.InsertColumn(2, 'Estoque local', format=wx.LIST_ALIGN_LEFT, width=120)
...
#-----: Consulta de Lista Giro-CURVA ABC
		...
		wx.StaticText(self.painel,-1, u"Descrição,Codigo,Barra,P:expressão,F:Fabricante,G:Grupo\nI:Interno,[*]-Encadeado", pos=(18,456)).SetFont(wx.Font(7,wx.MODERN,wx.NORMAL, wx.NORMAL,False,"Arial"))
		wx.StaticText(self.painel,-1, u"Codigo", pos=(309,466)).SetFont(wx.Font(7,wx.MODERN,wx.NORMAL, wx.NORMAL,False,"Arial"))
		...
		self.entra = wx.RadioButton(self.painel,-1,"Entrada", pos=(18, 428),style=wx.RB_GROUP)
		self.saida = wx.RadioButton(self.painel,-1,"Saida  ", pos=(100,428))
		...
		if sql[0]:
			...
			for i in result:
				...
				if i[79] !='T':
					...
					relacao[_registros] = str(i[2]),i[3],str(i[7])+'-'+flps,str(i[94]),str(i[23]),str(i[9]),_mrg,_pvd,str(i[5]),ucompras,str(i[8]),str(i[35]),str(i[36]),str(i[37]),str(i[38]),str(i[39]),str(i[0]),str(i[21]),str(i[70]),str(i[16]),str(i[52]),str( i[94] ),str( i[47] ),str( i[16] ),str( i[17] ), ajus, cABC, _pfl, _lsF,str( i[68] ), vlrad_2,vlrad_3,vlrad_4,vlrad_5,vlrad_6, __ef, _par, i[75]
...
#-: Inserir dados ]
	def insercao(self,event):
		...
		if passar == True:
			...
			#		"""   ToTaliza QT Embalagem x QT de Embalagem comprada   """
			#		embmetros.calcularEmbalagens( _p, ( parent.q, lProdu[24], indPos, vTP ) )
			...
			if not self.p.devolu.GetValue() and self.medcalc.GetValue() and e:

				quantidade_unidade, valor_unitario = embmetros.calcularEmbalagensAutomatico( self.p, ( Decimal( e ), Decimal( _vp ), Decimal( _qT ), cdindice ), False )
			...
			if not self.p.devolu.GetValue() and self.medcalc.GetValue() and m and len( m.split("|") ) >=6:
				...
				#			"""  Calculo de metros para unidades  """
				#			__m = self.list_compra.GetItem( self.list_compra.GetFocusedItem(),  36 ).GetText()
				#			if self.medcalc.GetValue() and __m and len( __m.split("|") ) >=6:
								
				#				com, lar, exp = Decimal( __m.split('|')[3] ), Decimal( __m.split('|')[4] ), Decimal( __m.split('|')[5] )
								
				#				__mt = ( com * lar * exp )
				#				__r =  nF.metrosUnidade( 1,  __m, _qT, _vp )
								
				#				if __mt and __r[0]:
									
				#					self.p.ListaCMP.SetStringItem(indice,69, str( __r[1] ) ) #-: Quantidade
				#					self.p.ListaCMP.SetStringItem(indice,77, str( __r[2] ) ) #-: Valor unitario
	...
	def desenho(self,event):
		...
		dc.SetPen(wx.Pen(cores.boxcaixa, 1, wx.SOLID))
		dc.SetBrush(wx.Brush('#CCCCFF', wx.TRANSPARENT))
		dc.DrawRoundedRectangle(13, 384, 202, 40, 3)
