...
#-----: altera para nota fiscal de bonificacao
	...
	def statusnfe(self,event):
		...
		#if len( login.filialLT[ self.filial_notas ] ) >= 31 and len( login.filialLT[ self.filial_notas ][30].split(';') ) >= 3 and login.filialLT[ self.filial_notas ][30].split(';')[2] == "4.00":	
		NFE40Eve.status( self, ( self.filial_notas, 55  ) )
