...
#---{ Eventos }-------------------------------------------------// Inutilizacao da NF	
	def inutilizarNfe(self, parent, filial, ambiente, nota_fiscal, motivo, nfe_nfce, dav, id_lancamento, tipo_pedido, serie ):
		...
		'nota_inicial':str( int(nota_fiscal) ).zfill(9),
		'nota_final':str( int(nota_fiscal) ).zfill(9),
		'modelo':str( nfe_nfce ),
		'serie':str( serie ).zfill(3),
		'justificativa':informes.remover_acentos( motivo )
		}
		try:
...
#---{ Eventos }-------------------------------------------------// Cancelamento da NF
	def cancelamentoNfe(self, parent, filial='', xml='', motivo='', origem = '', retorno_html = '' ):
		...
		xml_retorno = msf.sefazEventos( 'Cancelamento', dados_cancelamento )
		#print('----------------------------\n',xml_retorno)
...
#---{ Dados-Certificados Retornos SEFAZ }--------------------------// Certificado
	def certificados(self,filial, parent, nf_modelo=55 ):
		...
		try:
			...
			NotaFiscalParametros.modelo = nf_modelo
